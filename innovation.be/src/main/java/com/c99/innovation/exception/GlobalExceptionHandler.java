...
import static com.c99.innovation.common.constant.Constants.BAD_CREDENTIALS;
import static com.c99.innovation.common.constant.Constants.SERVER_ERROR_MESSAGE;
import static com.c99.innovation.common.constant.Constants.USERNAME_NOT_FOUND;

@RestControllerAdvice(basePackages = "com.c99.innovation")
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseDTO<Object> handleUnwantedException(Exception ex) {
        return new ResponseDTO<>(HttpStatus.INTERNAL_SERVER_ERROR, SERVER_ERROR_MESSAGE, null);
    }
    ...
    public ResponseDTO<Object> handleInternalAuthenticationServiceException(UsernameNotFoundException exception) {
        return new ResponseDTO<>(HttpStatus.UNAUTHORIZED, USERNAME_NOT_FOUND, null);
    }

    @ExceptionHandler(BadCredentialsException.class)
    @ResponseStatus(code = HttpStatus.UNAUTHORIZED)
    public ResponseDTO<Object> handleBadCredentialsException(BadCredentialsException exception) {
        return new ResponseDTO<>(HttpStatus.UNAUTHORIZED, BAD_CREDENTIALS, null);
    }
