...
public class HTTPSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        final String[] administratorURLList = ADMINISTRATOR_PREREQUISITES_URL_LIST.stream()
                .map(URL -> API_V1 + URL)
        ...
        http
                ...
                .antMatchers(HttpMethod.PATCH, administratorURLList).hasAnyAuthority(ADMIN_AUTHORITY_VALUE)
